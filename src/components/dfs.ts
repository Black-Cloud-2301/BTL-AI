...
import { arrLength, isEquals, isExist, swapArray2d } from './functions';
...
export function DepthFirstSearch(array: number[][]) {
  ...
  while (true) {
    ...
    if (tempStack) {
      const row = tempStack.array.findIndex((row) => row.includes(search));
      const col = tempStack.array[row].indexOf(search);
      if (row === 0) {
        let newTempArray1: number[][] = [];
        for (let i = 0; i < arrLength; i++) {
          newTempArray1[i] = tempStack.array[i].slice();
        }
        ...
        if (col === 0) {
          ...
          for (let i = 0; i < arrLength; i++) {
            newTempArray2[i] = tempStack.array[i].slice();
          }
          ...
          if (col === arrLength - 1) {
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray3[i] = tempStack.array[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray4[i] = tempStack.array[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray5[i] = tempStack.array[i].slice();
            }
        ...
        for (let i = 0; i < arrLength; i++) {
          newTempArray6[i] = tempStack.array[i].slice();
        }
        ...
        if (col === 0) {
          ...
          for (let i = 0; i < arrLength; i++) {
            newTempArray7[i] = tempStack.array[i].slice();
          }
          ...
          if (col === arrLength - 1) {
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray8[i] = tempStack.array[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray9[i] = tempStack.array[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray10[i] = tempStack.array[i].slice();
            }
        ...
        for (let i = 0; i < arrLength; i++) {
          newTempArray11[i] = tempStack.array[i].slice();
        }
        ...
        for (let i = 0; i < arrLength; i++) {
          newTempArray12[i] = tempStack.array[i].slice();
        }
        ...
        if (col === 0) {
          ...
          for (let i = 0; i < arrLength; i++) {
            newTempArray13[i] = tempStack.array[i].slice();
          }
          ...
          if (col === arrLength - 1) {
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray14[i] = tempStack.array[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray15[i] = tempStack.array[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray16[i] = tempStack.array[i].slice();
            }
    ...
    const tempOpenQueue = openQueue.slice(0, 4 * 4).sort(function () {
      return Math.random() - 0.5;
    });
    for (let i = 0; i < tempOpenQueue.length; i++) {
      if (isEquals(tempOpenQueue[i].array, targetArray)) {
        console.log(tempOpenQueue[i].father);
        console.log('Founded');
        let t1 = performance.now();
        console.log(t1 - t0);
        return tempOpenQueue[i].father;
      } else {
        stack.unshift(tempOpenQueue[i]);
      }
    }
  }
  return [array];
