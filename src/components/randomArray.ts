import { arrLength, isExist, swapArray2d } from './functions';

export function randomArray(array: number[][]) {
  const search = 0;
  ...
  for (let index = 0; index < 20; index++) {
    ...
    if (newArray) {
      ...
      const col = newArray[row].indexOf(search);
      if (row === 0) {
        let newTempArray1: number[][] = [];
        for (let i = 0; i < arrLength; i++) {
          newTempArray1[i] = newArray[i].slice();
        }
        ...
        if (col === 0) {
          ...
          for (let i = 0; i < arrLength; i++) {
            newTempArray2[i] = newArray[i].slice();
          }
          ...
          if (col === arrLength - 1) {
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray3[i] = newArray[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray4[i] = newArray[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray5[i] = newArray[i].slice();
            }
        ...
        for (let i = 0; i < arrLength; i++) {
          newTempArray6[i] = newArray[i].slice();
        }
        ...
        if (col === 0) {
          ...
          for (let i = 0; i < arrLength; i++) {
            newTempArray7[i] = newArray[i].slice();
          }
          ...
          if (col === arrLength - 1) {
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray8[i] = newArray[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray9[i] = newArray[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray10[i] = newArray[i].slice();
            }
        ...
        for (let i = 0; i < arrLength; i++) {
          newTempArray11[i] = newArray[i].slice();
        }
        ...
        for (let i = 0; i < arrLength; i++) {
          newTempArray12[i] = newArray[i].slice();
        }
        ...
        if (col === 0) {
          ...
          for (let i = 0; i < arrLength; i++) {
            newTempArray13[i] = newArray[i].slice();
          }
          ...
          if (col === arrLength - 1) {
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray14[i] = newArray[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray15[i] = newArray[i].slice();
            }
            ...
            for (let i = 0; i < arrLength; i++) {
              newTempArray16[i] = newArray[i].slice();
            }
    ...
    const tempQueue = openQueue.slice(0, 4 * 4).sort(function () {
      return Math.random() - 0.5;
    });

    newArray = tempQueue[0];
    arrayStatePass.push(tempQueue[0]);
  }
  return newArray;
}
